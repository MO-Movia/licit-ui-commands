...
describe('toggleList', () => {
  ...
  it('transformAndPreserveTextSelection without setSelection {selection}', () => {
    ...
    const listNodeType = {} as unknown as NodeType;
    const sc = {
      marks: {'mark-text-selection': MARK_TEXT_SELECTION},
      nodes: {paragraph: PARAGRAPH, heading: HEADING},
  ...
  it('transformAndPreserveTextSelection calling with scehema, selection, doc checking condition !currentNode && prevNode && prevNode.type.name === TEXT', () => {
    ...
    jest
      .spyOn(TextSelection, 'create')
      .mockReturnValueOnce({} as unknown as TextSelection)
      .mockReturnValueOnce({} as unknown as TextSelection)
      .mockReturnValueOnce({doc: dummyDoc} as unknown as TextSelection);
    jest
      .spyOn(prossermirror_utlites, 'findParentNodeOfType')
      .mockReturnValue(() => {
        return {} as unknown as prossermirror_utlites.ContentNodeWithPos;
    ...
    const tr = {
      ...
      setSelection: (_a) => {
        return {
          ...
          selection: {from: 0, to: 1, heading: HEADING},
          doc: dummyDoc,
        };
      },
    } as unknown as Transform;
  ...
  it('toggleList function() should be return defined value, If setNodeMarkup is there', () => {
    ...
    jest
      ...
      .mockReturnValueOnce(true)
      .mockReturnValueOnce(true)
      .mockReturnValueOnce(false) as unknown as Node;
